...
subtitle: Modifying response headers to enforce the security of the web application
description: An overview of the recently launched AWS CloudFront Functions service with a practical example
